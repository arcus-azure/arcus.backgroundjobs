...
{
    public class CloudEventToEventGridAzureServiceBusMessageHandler : IAzureServiceBusMessageHandler<CloudEvent>
    {
        private readonly IEventGridPublisher _eventGridPublisher;
        private readonly ILogger<OrdersAzureServiceBusMessageHandler> _logger;

        public CloudEventToEventGridAzureServiceBusMessageHandler(IEventGridPublisher eventGridPublisher, ILogger<OrdersAzureServiceBusMessageHandler> logger)
        {
